...
.controller('TodoCtrl', function($scope, $firebase, $timeout, Modal, Projects) {
  ...
  $scope.projectsList = $firebase(new Firebase("https://loot-card.firebaseio.com/projects"));
  $scope.user = $firebase(new Firebase("https://loot-card.firebaseio.com/Users/John"));
